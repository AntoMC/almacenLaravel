...
role="dialog" tabindex="-1" id="modal-delete-{{$loc->idlocalidad}}">
	{{Form::Open(array('action'=>array('LocalidadController@destroy',$loc->idlocalidad),'method'=>'delete'))}}
	<div class="modal-dialog fondo-modal-transp">
		<div class="modal-content fondo-transp">
			<div class="modal-header">
                ...
                <h4 class="modal-title texto-amc">Eliminar Localidad</h4>
			</div>
